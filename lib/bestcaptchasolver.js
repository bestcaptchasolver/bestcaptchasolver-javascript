 ...
 * @returns {Promise<any>}
 */
bestcaptchasolverapi.submit_hcaptcha = function (data) {
    var bc = bestcaptchasolver_config;    // get config obj
    return new Promise((resolve, reject) => {
        data.access_token = bc.access_token;
        var url = bc.BASE_URL + '/captcha/hcaptcha';
 ...
 * @returns {Promise<any>}
 */
bestcaptchasolverapi.submit_task = function (data) {
    var bc = bestcaptchasolver_config;    // get config obj
    return new Promise((resolve, reject) => {
        data.access_token = bc.access_token;
        var url = bc.BASE_URL + '/captcha/task';
